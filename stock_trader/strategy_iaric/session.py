"""Thin runtime bootstrap for the IARIC strategy."""
...
async def bootstrap_runtime(config_dir: str | Path, settings: StrategySettings | None = None) -> RuntimeServices:
    ...
    effective_nav = resolve_paper_nav(raw_nav, Path("data/strategy_iaric/paper_capital_state.json"))
    ...
    instrumentation_kit = InstrumentationKit(instrumentation, strategy_type="strategy_iaric")
