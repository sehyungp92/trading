"""Farm connectivity monitor — detects IBKR farm state transitions."""
...
class FarmMonitor:
    ...
    Synchronous start/stop — only hooks/unhooks the ib_async errorEvent.
    """
