...
BASE_RISK_PCT: Final[float] = 0.0068
DAILY_STOP_R: Final[float] = 3.0
HEAT_CAP_R: Final[float] = 1.5
PORTFOLIO_DAILY_STOP_R: Final[float] = 2.25
...
STRUCTURAL_ENTRY_MODE: Final[str] = "hybrid_close_adaptive"
...
REVERSION_SWING_RADIUS: Final[int] = 2
...
SECOND_WIND_MIN_VOLUME_MULTIPLE: Final[float] = 1.2
