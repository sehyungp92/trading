...
For the recommended patch, 0-24-bar trades contribute -13.85R across 38 trades and 25+-bar trades contribute +53.06R across 66 trades. This is an opportunity/selection uplift; it does not eliminate the structurally negative short-hold cohort.
...
|---|---:|---:|---:|---:|---:|---:|:---:|
| ablate__use_adaptive_trail | -7.81 | -5.58 | -279.46 | 0.80 | 59.1 | 36.8% | fail |
| ablate__adaptive_trail_start_bars | -7.81 | -5.58 | -279.46 | 0.80 | 59.1 | 36.8% | fail |
| ablate__adaptive_trail_tighten_bars | -12.71 | +0.00 | -207.47 | 0.94 | 63.0 | 18.6% | fail |
| ablate__fr_trailing_activate_r | -26.89 | +13.19 | -206.32 | 0.97 | 71.1 | 14.9% | fail |
| ablate__use_partial_takes | -5.40 | +0.51 | -4.54 | 1.64 | 63.9 | 3.8% | fail |
| restore__round1_exact_delta | -6.67 | -0.51 | -100.87 | 1.30 | 63.2 | 4.7% | fail |
| ablate__combined_avwap_cap_pct | -1.40 | -2.54 | -0.79 | 1.72 | 56.4 | 3.7% | fail |
| ablate__use_combined_quality_gate | -2.92 | +5.58 | +2.36 | 1.65 | 68.8 | 3.1% | pass |
| ablate__failure_stop_bars | -3.12 | +0.51 | +5.36 | 1.66 | 63.1 | 3.9% | pass |
| ablate__flow_reversal_min_hold_bars | -9.33 | +2.03 | +10.08 | 1.71 | 65.1 | 3.5% | pass |
| ablate__carry_min_cpr | -2.81 | +0.00 | +0.00 | 1.67 | 63.7 | 3.9% | pass |
| ablate__carry_min_r | -2.81 | +0.00 | -2.26 | 1.65 | 63.6 | 3.9% | pass |
| ablate__fr_cpr_threshold | -2.74 | +0.00 | -1.68 | 1.65 | 63.7 | 3.9% | pass |
| ablate__use_mfe_conviction_exit | -2.87 | +0.00 | +2.93 | 1.67 | 63.6 | 3.9% | pass |
| ablate__combined_breakout_score_min | -2.81 | +0.00 | +4.92 | 1.67 | 64.1 | 3.8% | pass |
...
| Candidate | OOS delta R | OOS delta trades/mo | IS delta R | IS PF | IS trades/mo | IS DD | Guardrail |
|---|---:|---:|---:|---:|---:|---:|:---:|
| ablate__rvol_threshold | -5.50 | -4.57 | -22.36 | 1.61 | 58.3 | 3.4% | fail |
| ablate__use_or_width_min | -2.81 | +0.00 | +0.00 | 1.67 | 63.7 | 3.9% | pass |
...
| perturb__opening_range_bars__5 | perturbation | +0.132 | no | yes | no | +45.99 | 59.9 | 2.74 |
...
| target__or5_stop090 | targeted | +0.040 | no | yes | no | +38.59 | 59.4 | 2.62 |
| target__or5_heat400_capacity6 | targeted | +0.038 | no | yes | no | +38.59 | 58.3 | 2.58 |
| target__or5_heat400_daily300 | targeted | +0.038 | no | yes | no | +38.59 | 58.3 | 2.58 |
| target__contain_score67_sizing | targeted | +0.027 | no | yes | no | +37.89 | 47.7 | 3.47 |
| target__or5_failure8 | targeted | +0.027 | no | yes | no | +38.29 | 58.8 | 2.51 |
| target__failure8_mfe015_to_m020 | targeted | +0.018 | yes | yes | yes | +38.75 | 47.7 | 3.32 |

## Exploratory recommendation

`combo__target__failure8_mfe015_to_m020__plus__target__frequency_entry1300` is the highest balanced-score exploratory configuration among candidates that strictly raise OOS total R, net PnL, and frequency and pass the predefined IS degradation limits. It is **not approved for promotion** because the targeted search inspected this OOS sample and the authoritative bundle is absent.

Effective delta: `param_overrides.failure_stop_bars` = `8`, `param_overrides.failure_stop_mfe_max_r` = `0.15`, `param_overrides.failure_stop_to_r` = `-0.2`, `param_overrides.entry_window_end` = `13:00:00`.

| Configuration | Window | Trades | Win rate | Avg R | Total R | PF | Net PnL | Trades/month | Max DD |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| recommended | IS | 1611 | 54.9% | +0.118 | +190.35 | 1.68 | $19,662.03 | 69.7 | 3.5% |
| recommended | OOS | 104 | 60.6% | +0.377 | +39.21 | 3.00 | $1,989.62 | 52.8 | 1.6% |
