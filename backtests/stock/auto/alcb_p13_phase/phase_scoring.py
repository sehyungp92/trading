...
PHASE_SCORING_WEIGHTS: dict[int, dict[str, float]] = {
    ...
    2: {  # Loss management
        "profit_protection": 0.26,
        "short_hold_drag_inverse": 0.22,
        "expected_total_r": 0.18,
        "expectancy_dollar": 0.16,
        "trades_per_month": 0.10,
        "inv_dd": 0.08,
    },
    3: {  # Winner capture
        "long_hold_capture": 0.28,
        "expectancy_dollar": 0.22,
...
NORMALIZATION_CEILINGS: dict[str, float] = {
    "expectancy_dollar": 8.0,      # was 3.0 -- P11 at $3.90 normalizes to 0.49
    "expected_total_r": 80.0,      # was 25.0 -- P11 at 54.47R normalizes to 0.68
    "trades_per_month": 50.0,      # unchanged -- P11 at 31.17 normalizes to 0.62
    "profit_factor": 2.50,         # was 1.50 -- P11 at 1.35 normalizes to 0.54
    "entry_quality": 1.0,
    "high_rvol_edge": 1.0,
