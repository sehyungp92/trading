"""Standalone CLI for ALCB P11 phased auto-optimization.

Usage::

    python -m research.backtests.stock.auto.alcb_p11_phase.cli --data-dir research/backtests/stock/data/raw --max-workers 3
    python -m research.backtests.stock.auto.alcb_p11_phase.cli --phase 1
    python -m research.backtests.stock.auto.alcb_p11_phase.cli --experiments p11_rvol_200 p11_no_pdh
"""
...
def _build_runner(args: argparse.Namespace):
    ...
    from .plugin import ALCBP11Plugin
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="alcb-p11-phase",
        description="ALCB P11 phased auto-optimization (6 phases, ~86 candidates)",
    )
    parser.add_argument("-v", "--verbose", action="store_true")
    parser.add_argument("--data-dir", default="research/backtests/stock/data/raw")
    parser.add_argument("--output-dir", default="research/backtests/stock/auto/alcb_p11_phase/output_multiphase")
