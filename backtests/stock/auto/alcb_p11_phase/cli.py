...
Usage::
    ...
    python -m backtests.stock.auto.alcb_p11_phase.cli --data-dir backtests/stock/data/raw --max-workers 3
    python -m backtests.stock.auto.alcb_p11_phase.cli --phase 1
    python -m backtests.stock.auto.alcb_p11_phase.cli --experiments p11_rvol_200 p11_no_pdh
"""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="backtests/stock/auto/alcb_p11_phase/output_multiphase")
