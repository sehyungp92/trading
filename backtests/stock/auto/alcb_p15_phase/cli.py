"""Standalone CLI for ALCB P15 phased auto-optimization.

Usage::

    python -m backtests.stock.auto.alcb_p15_phase --max-workers 2 -v
    python -m backtests.stock.auto.alcb_p15_phase --phase 1
"""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="backtests/stock/auto/alcb_p15_phase/output")
    ...
    if args.phase is not None:
        ...
        print(f"ALCB P15 phase {args.phase} complete.")
        ...
        print("ALCB P15 phased auto-optimization complete.")
