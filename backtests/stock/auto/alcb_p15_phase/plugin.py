...
# P15 uses broad floors so structural candidates can surface without allowing
# obviously degraded variants through the greedy search.
# ---------------------------------------------------------------------------
...
ULTIMATE_TARGETS = {
    ...
    "expected_total_r": 95.0,
    "trades_per_month": 26.0,
    "profit_factor": 2.10,
    "entry_quality": 0.90,
    "high_rvol_edge": 0.70,
    ...
    "long_hold_capture": 0.70,
    "carry_capture": 0.20,
    "inv_dd": 0.75,
    "mfe_capture_efficiency": 0.50,
}
...
def _build_phase_snapshot(
    ...
    *,
    ...
    return "\n".join([
        "=" * 70,
        f"ALCB P15 SHARED PHASE {phase} SNAPSHOT",
        "=" * 70,
        f"Focus: {focus}",
