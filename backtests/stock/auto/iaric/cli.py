...
def _build_runner(args: argparse.Namespace, *, for_write: bool = True) -> PhaseRunner:
    ...
    return PhaseRunner(
        ...
        round_name=f"iaric_{args.round_name}_{args.profile}",
...
def cmd_phase_auto(args: argparse.Namespace) -> None:
    ...
    print(f"IARIC phased auto-optimization complete ({runner.plugin.profile}, {args.round_name}).")
...
def main() -> None:
    ...
    def add_common(command: argparse.ArgumentParser) -> None:
        ...
        command.add_argument("--round-name", choices=ROUND_NAME_CHOICES, default="v4r1")
