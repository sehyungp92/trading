"""Standalone CLI for ALCB P14 phased auto-optimization.
...
def main() -> None:
    ...
    if args.phase is not None:
        ...
        print(f"ALCB P14 phase {args.phase} complete.")
        ...
        print("ALCB P14 phased auto-optimization complete.")
