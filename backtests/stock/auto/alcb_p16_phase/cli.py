"""Standalone CLI for ALCB P16 phased auto-optimization.

Usage::

    python -m backtests.stock.auto.alcb_p16_phase --max-workers 2 -v
    python -m backtests.stock.auto.alcb_p16_phase --phase 1
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="alcb-p16-phase",
        description="ALCB P16 phased auto-optimization (5 phases, targeted entry-repair scoring)",
    )
    parser.add_argument("-v", "--verbose", action="store_true")
    parser.add_argument("--data-dir", default="backtests/stock/data/raw")
    parser.add_argument("--output-dir", default="backtests/stock/auto/alcb_p16_phase/output")
    ...
    if args.phase is not None:
        ...
        print(f"ALCB P16 phase {args.phase} complete.")
        ...
        print("ALCB P16 phased auto-optimization complete.")
