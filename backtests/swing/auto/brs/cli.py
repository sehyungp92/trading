"""BRS phased auto-optimization CLI."""
...
ROUND_MANAGER = RoundManager("swing", "brs")
...
def cmd_phase_auto(args: argparse.Namespace) -> None:
    ...
    print("BRS auto-optimization complete.")
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="brs-auto", description="BRS phased auto-optimization")
    ...
    phase_auto = sub.add_parser("phase-auto", help="Run all BRS phases")
